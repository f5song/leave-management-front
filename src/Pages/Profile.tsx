                            ...
                            <div className="flex flex-col lg:flex-row pt-4 gap-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="relative w-[160px] h-[160px] group">
                                        <img className="w-[160px] h-[160px] rounded-[4px] border border-[#000000]" src={previewAvatar || user?.avatarUrl || "/default-avatar.png"} alt="avatar" />
                                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-2 rounded-[4px]">
                                            <label htmlFor="employee-image" className="cursor-pointer w-[94px] h-[40px] border border-white rounded-[4px] text-white font-sukhumvit font-bold text-[14px] leading-[100%] flex items-center justify-center">
                                                เปลี่ยนรูป
                                            </label>
                                        </div>
                                    </div>
                                    <input type="file" accept="image/*" id="employee-image" className="hidden" onChange={handleAvatarChange} />
                                </div>
